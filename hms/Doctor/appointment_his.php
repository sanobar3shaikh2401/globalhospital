 ...
 <!-- <div class="jumbotron" id="ab1"></div> --><br>
  	<div class="row" style="width: 100%; height: 60px; padding-left: 30px;">
  		<div class="col-md-12 bg-primary">
  			<h4 class="mt-3 text-light">Patient | Appointment History</h4>
  		</div>
	</div>
   <div class="container" style="margin-top:20px;">
      ...
      <div class="card-body">
        <table class="table table-hover">
          ...
          <tbody>
            <?php
$sql=mysqli_query($con,"select doctb.name as docname,appointment.*  from appointment join doctb on doctb.id=appointment.doctorId where appointment.userId='".$_SESSION['id']."'");
$cnt=1;
