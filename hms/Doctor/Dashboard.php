  ...
  <body style="padding-top:50px;">
  	...
  	<div class="row" style="width: 100%; height: 60px; padding-left: 30px;">
  		<div class="col-md-12 bg-primary">
  			<h4 class="mt-3 text-light">Doctor | Dashboard</h4>
  		</div>
	</div>
   		...
   		<div class="row">
   			...
   			<div class="col-md-4">
				  ...
				  <div class="card-body">
				   <div class="panel-body">
						<center>
							<h3 class="StepTitle">Appointment History</h3>
							<p class="cl-effect-1">
   			...
   			<div class="col-md-4">
				  ...
				  <div class="card-body">
				   <div class="panel-body">
						<center>
							<h3 class="StepTitle">Add Patient</h3>
							<p class="cl-effect-1">
							<a href="Add_patient.php">[View Add Patient]</a>
							</p>
						</center>
					</div>
				  </div>
