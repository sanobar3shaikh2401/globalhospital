 ...
 <!-- <div class="jumbotron" id="ab1"></div> --><br>
  	<div class="row" style="width: 100%; height: 60px; padding-left: 30px;">
  		<div class="col-md-12 bg-primary">
  			<h4 class="mt-3 text-light">Admin | Doctor Specialization</h4>
  		</div>
	</div>
   <div class="container" style="margin-top:20px;">
   		<div class="row">
   			<div class="col-md-12">
   				<div class="card text-dark" style="width: 35rem;">
                    ...
                    <input type="text" name="specialization" placeholder="Enter Doctor Specialization" class="form-control" required>
                    <br>
                    <input type="submit" name="doc_spe" value="Submit" class="btn btn-primary">
                  </form>	
  					</div>
  				  </div>
				  </div>
      ...
      <div class="card-body">
        <table class="table table-hover">
          ...
          <tbody>
             <?php get_doctor_specialization();  ?> 
            <!-- <tr>
              <td><?= $row; ?></td>
              <td><?= $row; ?></td>
              <td><a href='Dr_specialization_update.php?id=<?=$row; ?>'><i class='fas fa-edit' style ='color: #007bff;font-size:18px'>&nbsp; | &nbsp;</i></a>
              <a href=''><i class='fa fa-eye' style ='color: #007bff;font-size:18px'></i></td></a>
            </tr> -->
          </tbody>
        </table>
      </div>
