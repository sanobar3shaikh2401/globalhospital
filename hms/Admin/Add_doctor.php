...
<html lang="en">
 ...
 <!-- <div class="jumbotron" id="ab1"></div> --><br>
  	<div class="row" style="width: 100%; height: 60px; padding-left: 30px;">
  		<div class="col-md-12">
  			<h4 class="mt-3 text-dark">Admin | Add Doctor</h4>
  		</div>
	</div>
   		...
   		<div class="row">
            ...
            <div class="card-body" style="background-color: #007bff;color: #ffffff;">
              ...
              Add Doctor
                    ...
                    <input type="text" name="address" placeholder="Enter Doctor Clinic Address" class="form-control" required>
                    <br>
                    <label>Doctor Consultancy Fees: </label>
                    <input type="number" name="fees" placeholder="Enter Doctor Consultancy Fees" class="form-control" required>
                    <br>
                    <label>Doctor Contact no: </label>
                    <input type="number" name="contact" placeholder="Enter Doctor Contact no" class="form-control" required>
                    <br>
                    <label>Doctor Email: </label>
                    <input type="email" name="email" placeholder="Enter Doctor Email" class="form-control" required>
                    <br>
                    <label>Password: </label>
                    <input type="text" name="pass" placeholder="Enter Password" class="form-control" required>
                    <br>
                    <label>Confirm Password: </label>
                    <input type="text" name="conpass" placeholder="Enter Confirm Password" class="form-control" required>
                    <br>
                    <input type="submit" name="add_doc" value="Submit" class="btn btn-primary">
                  </form>	
  					</div>
  				  </div>
				  </div>
