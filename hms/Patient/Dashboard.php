  ...
  <body style="padding-top:50px;">
  	...
  	<div class="row" style="width: 100%; height: 60px; padding-left: 30px;">
  		<div class="col-md-12 bg-primary">
  			<h4 class="mt-3 text-light">Patient | Dashboard</h4>
  		</div>
	</div>
    ...
    <br><br><br><br>
        ...
        <div class="col-md-4">
          ...
          <div class="card-body">
           <div class="panel-body">
            <center>
              <h3 class="StepTitle">Book Appointment</h3>
              <p class="cl-effect-1">
              <a href="book_appo.php">[View Book Appointment]</a>
              </p>
            </center>
          </div>
          </div>
				  ...
				  <div class="card-body">
				   <div class="panel-body">
						<center>
							...
							<p class="cl-effect-1">
							<a href="appointment_his.php">[View Appointment History]</a>
							</p>
						</center>
					</div>
				  </div>
        ...
        <div class="col-md-4">
          ...
          <div class="card-body">
           <div class="panel-body">
            <center>
              <h3 class="StepTitle">Medical History</h3>
              <p class="cl-effect-1">
              <a href="manage_pat.php">[View Medical History]</a>
              </p>
            </center>
          </div>
          </div>
				  ...
				  <div class="card-body">
				   <div class="panel-body">
						<center>
							...
							<p class="cl-effect-1">
							<a href="manage_pat.php">[View Manage Patient]</a>
							</p>
						</center>
					</div>
				  </div>
